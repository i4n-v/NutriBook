<div x-show="click" class="grid grid-rows-2 my-1 divide-y bg-white text-gray-900 absolute left-100 top-100 w-1/6 text-center font-semibold right-2 top-13 rounded-lg shadow-2xl">
